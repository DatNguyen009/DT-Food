    ...
    methods: {
        ...
        countdown() {
            ...
            if (today.getDate() < 10) {
                ...
                this.dateNow1 = `${today.getFullYear()}-0${today.getMonth()+1}-0${today.getDate()} ${today.getHours()}:${today.getMinutes()}`;
                ...
                this.dateNow1 = `${today.getFullYear()}-0${today.getMonth()+1}-${today.getDate()} 19:30`;
                today.setDate(new Date().getDate() + 1);
