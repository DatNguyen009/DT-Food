            ...
            <el-tabs tab-position="top">
                ...
                <el-tab-pane label="Thêm nguyên liệu">
                    <el-form ref="material" :model="material">
                        ...
                        <el-form-item label="Chọn ảnh">
                            <el-upload ref="imageMaterial" class="upload-demo" action="#" accept="image/*" :on-remove="handleRemove" :before-remove="beforeRemove" :limit="1" :on-exceed="handleExceed" :file-list="fileList" :auto-upload="false">
                ...
                <el-tab-pane label="Thêm ảnh">
                    <el-form>
                        ...
                        <el-form-item label="Chọn ảnh">
                            <el-upload ref="file" class="upload-demo" action="#" accept="image/*" :on-remove="handleRemove" :before-remove="beforeRemove" :limit="1" :on-exceed="handleExceed" :file-list="fileList" :auto-upload="false">
                                <el-button size="small" type="primary">Click to upload</el-button>
                                <div slot="tip" class="el-upload__tip">file ảnh loại nào cũng được nhá</div>
                            </el-upload>
    ...
    methods: {
        ...
        uploadFood(inforFood) {
            Axios.post('http://localhost:8080/apiDTfood/public/api/v1/uploadFood', {
                ...
                .then(res => {
                    if (res.data == "success") {
                        this.notifyMessage("Thành công", "Thêm sản phẩm thành công!!!", "success", "top-right");
                        this.inforFood.name = "";
                ...
                .catch(() => {
                    this.notifyMessage("Thất bại", "Thêm sản phẩm thất bại!!!", "error", "top-left");
                })
        },
                        ...
                        new Promise(function (resolve) {
                            ...
                            .then(res => {
                                Axios.post("http://localhost:8080/apiDTfood/public/api/v1/postMaterial", {
                                    ...
                                    .then(res => {
                                        if (res.data == "success")
                                            this.notifyMessage("Thành công", "Thêm nguyên liệu thành công!!!", "success", "top-right");
                                    })
                                    .catch(() => {
                                        this.notifyMessage("Thất bại", "Thêm nguyên liệu thất bại!!!", "error", "top-left");
                                    })
                            })
