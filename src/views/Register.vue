...
<div class="contact__content">
    ...
    <div class="container">
        <el-form :model="ruleForm" status-icon :rules="rules" :ref="ruleForm" label-width="200px" class="demo-ruleForm" style="margin: 10rem">
            <el-form-item label="Nhập họ vè tên" prop="name" :rules="[
                { required: true, message: 'Tên không được bỏ trống', trigger: 'change'},
            ]">
                <el-input type="text" v-model="ruleForm.name" autocomplete="off" placeholder="Họ và tên"></el-input>
            </el-form-item>
            <el-form-item label="Nhập Email" prop="user">
                <el-input type="text" v-model="ruleForm.user" autocomplete="off" placeholder="Email"></el-input>
            </el-form-item>
            <el-form-item label="Nhập địa chỉ" prop="address" :rules="[
                { required: true, message: 'Địa chỉ không được bỏ trống', trigger: 'change'},
            ]">
                <el-input type="text" v-model="ruleForm.address" autocomplete="off" placeholder="Địa chỉ"></el-input>
            </el-form-item>
            <el-form-item label="Nhập số điện thoại" prop="phoneNumber" :rules="[
            { required: true, message: 'Số điện thoại không được bỏ trống', trigger: 'change'},
            { type: 'number', message: 'Số điện thoại không hợp lệ!!!'}
         ]">
                <el-input type="tel" v-model.number="ruleForm.phoneNumber" autocomplete="off" placeholder="Số điện thoại"></el-input>
            </el-form-item>
            ...
            { min: 6, message: 'Độ dài của mật khẩu phải lớn hơn 5', trigger: 'change'},
                ...
                <el-input type="password" v-model="ruleForm.pass" autocomplete="off" placeholder="Mật khẩu"></el-input>
            </el-form-item>
            ...
            { min: 6, message: 'Độ dài của xác nhận mật khẩu phải lớn hơn 5', trigger: 'change'},
                ...
                <el-input type="password" v-model="ruleForm.confirmPass" @keyup.enter="Submit(ruleForm)" autocomplete="off" placeholder="mật khẩu xác nhận"></el-input>
            </el-form-item>
            <el-form-item style="display: flex; justify-content: center">
                <el-button type="primary" @click="Submit(ruleForm)" @keyup.enter="Submit(ruleForm)">Đăng ký</el-button>
            </el-form-item>
        </el-form>
    </div>
</div>
                        ...
                        Axios.post("http://localhost:8080/apiDTfood/public/api/v1/register", {
                            ...
                            .then((res) => {
                                ...
                                if (res.data.result == "fail") {
                                  this.notifyMessage("Thất bại", "Email đã tồn tại", "error", "top-right");

                                } else {
                                  this.notifyMessage("Thành công", "Đăng ký thành công", "success", "top-left");
                                    this.$router.push({
                                        path: '/login'
                                    });
                                }
